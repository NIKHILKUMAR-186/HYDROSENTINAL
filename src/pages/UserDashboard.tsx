                  ...
                  <div className="flex flex-col gap-4">
                    <div className="space-y-2">
                      ...
                      <p className="max-w-3xl text-sm text-slate-600 dark:text-slate-400">
                        Full alert operations, incident timeline, and AI-assisted root cause analysis in a dedicated workspace.
                      </p>
                    </div>
                    <div className="rounded-[2rem] border border-slate-200/70 bg-slate-50/90 p-4 dark:border-slate-700 dark:bg-slate-950/70">
                      <AlertPanel
